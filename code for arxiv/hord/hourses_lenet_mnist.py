...
np.savetxt('pop_reserve_lenet_mnist.txt',pop_reserve,delimiter=',')    
np.savetxt('fitness_reserve_lenet_mnist.txt',fitness_reserve,delimiter=',') 
...
np.save('test_error_lenet_mnist.npy',test_error) 
