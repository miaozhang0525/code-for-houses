...
np.savetxt('pop_reserve_lung_nodule.txt',pop_reserve,delimiter=',')    
np.savetxt('fitness_reserve_lung_nodule.txt',fitness_reserve,delimiter=',') 
...
np.save('select_hp_lung_nodule.txt',select_hp) 
np.save('test_error_lung_nodule.npy',test_error) 
