...
rootdir='/home/jiahzhao/Desktop/result for houses-ALL-final/lenet-result'
...
for ii in range(0,len(result_list)):
    ...
    def model(x, is_train=True, reuse=False):
        ...
        with tf.variable_scope("binarynet", reuse=reuse):
            ...
            net = tl.layers.BatchNormLayer(net,is_train=True, act=tf.nn.relu, name='bn0')
            ...
            net = tl.layers.DropoutLayer(net, keep=drop_out_rate1, is_fix=True, is_train=is_train,name='drop1_1')
            ...
            net= tl.layers.DenseLayer(net,
                                      ...
                                      b_init_args = {},
                                      name ='dense_layer1',)
            net = tl.layers.DropoutLayer(net, keep=drop_out_rate2,is_fix=True, is_train=is_train, name='drop1')
            net= tl.layers.DenseLayer(net,
                                      n_units = dense2,
                                      act = tf.nn.relu,
                                      W_init = tf.truncated_normal_initializer(stddev=0.1),
                                      ...
                                      b_init_args = {},
                                      name ='dense_layer2',)
            net = tl.layers.DropoutLayer(net, keep=drop_out_rate3,is_fix=True, is_train=is_train, name='drop2')
