...
np.savetxt('pop_reserve_lenet_UCB_mnist.txt',pop_reserve,delimiter=',')    
np.savetxt('fitness_reserve_lenet_UCB_mnist.txt',fitness_reserve,delimiter=',') 
...
np.save('select_hp_lenet_UCB_mnist.txt',test_error) 
np.save('test_error_lenet_UCB_mnist.txt',test_error) 
