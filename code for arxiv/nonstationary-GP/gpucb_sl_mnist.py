...
np.savetxt('pop_reserve_sl_mnist_EI.txt',pop_reserve,delimiter=',')    
np.savetxt('fitness_reserve_sl_mnist_EI.txt',fitness_reserve,delimiter=',') 
...
np.save('select_hp_sl_mnist_EI.txt',select_hp) 
np.save('test_error_sl_mnist_EI.txt',test_error) 
