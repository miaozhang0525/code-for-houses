...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 29 19:16:24 2018
...
x_train = np.load('/home/mzhang3/Desktop/cancer classification/x_train_triple.npy')
y_train = np.load('/home/mzhang3/Desktop/cancer classification/y_train_triple.npy')

x_final_test = np.load('/home/mzhang3/Desktop/cancer classification/x_test_triple.npy')
y_final_test= np.load('/home/mzhang3/Desktop/cancer classification/y_test_triple.npy')
...
N_GENERATIONS = 2
x_bound = np.array([[10, 10,10, 10,10,10,30,200,30],[70,70,70,70,70,70,70,400,70]])      # x upper and lower bounds
...
def get_reward_test(x_train, y_train, x_test, y_test, hp_setting):     
    ...
    for it in range(n_val):      
        ...
        x = tf.placeholder(tf.float32, shape=[None, 52, 52], name='x')
        ...
        out = tl.layers.DenseLayer(drop2, n_units=3,
                                         act = tf.identity,
                                         name='output_layer')
        ...
        tl.utils.fit(sess, out, train_op, cross_entropy, x_train, y_train, x, y_,
                    acc=accuracy, batch_size=50, n_epoch=300, print_freq=10,
        ...
        for step in range(0, iteration):
            ...
            c_mat, f1, batch_acc, f1_macro = tl.utils.evaluation(batch_y, y_prediction, 3)
...
np.savetxt('pop_reserve_UBC_lung_nodule.txt',pop_reserve,delimiter=',')    
np.savetxt('fitness_reserve_UBC_lung_nodule.txt',fitness_reserve,delimiter=',') 
...
np.save('select_hp_UBC_lung_nodule.txt',select_hp) 
np.save('test_error_UBC_lung_nodule.txt',test_error) 
