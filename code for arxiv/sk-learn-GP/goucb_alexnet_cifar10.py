...
np.savetxt('pop_reserve_alexnet_EI_cifar10.txt',pop_reserve,delimiter=',')    
np.savetxt('fitness_reserve_alexnet_EI_cifar10.txt',fitness_reserve,delimiter=',') 
...
np.save('select_hp_alexnet_EI_cifar10.txt',select_hp) 
np.save('test_error_alexnet_EI_cifar10.txt',test_error) 
