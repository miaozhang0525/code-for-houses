...
x_final_test = np.load('/home/jiahzhao/Desktop/cancer classification/x_test_triple.npy')
y_final_test= np.load('/home/jiahzhao/Desktop/cancer classification/y_test_triple.npy')
...
np.savetxt('pop_reserve_PI_lung_nodule.txt',pop_reserve,delimiter=',')    
np.savetxt('fitness_reserve_PI_lung_nodule.txt',fitness_reserve,delimiter=',') 
...
np.save('select_hp_alexnet_PI_lung_nodule.txt',select_hp) 
np.save('test_error_PI_lung_nodule.txt',test_error) 
