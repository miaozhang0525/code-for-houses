...
# Hyper Parameters   
    ...
    for pp in range(n_val):  
        ...
        tl.utils.fit(sess, out, train_op, cross_entropy, x_train, y_train, x, y_,
                    acc=accuracy, batch_size=200, n_epoch=100, print_freq=1,
                    X_val=x_test, y_val=y_test, eval_train=True,)
...
np.savetxt('pop_reserve_rand_lenet_mnist.txt',select_hp,delimiter=',')    

np.save('test_error_rand_lenet_mnist.npy',test_error) 
