...
best = fmin(get_reward, space, algo=rand.suggest,max_evals=200/n_val)
...
np.savetxt('pop_reserve_rand_sl_conv_lung_nudule.txt',select_hp,delimiter=',')    

np.save('test_error_rand_sl_conv_lung_nudule.npy',test_error) 