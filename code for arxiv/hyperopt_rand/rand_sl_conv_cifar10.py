...
best = fmin(get_reward, space, algo=rand.suggest,max_evals=2)
...
np.savetxt('pop_reserve_rand_sl_conv_cifar10.txt',select_hp,delimiter=',')    

np.save('test_error_rand_sl_conv_cifar10.npy',test_error) 