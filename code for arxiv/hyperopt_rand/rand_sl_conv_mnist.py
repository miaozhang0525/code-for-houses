...
best = fmin(get_reward, space, algo=rand.suggest,max_evals=1)
...
np.savetxt('pop_reserve_rand_sl_conv_mnist.txt',select_hp,delimiter=',')    

np.save('test_error_rand_sl_conv_mnist.npy',test_error) 
